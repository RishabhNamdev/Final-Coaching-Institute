...
public class StudentServiceImpl implements StudentService {
	...
	public Student saveStudent(Student student) {
			...
			if (student.getFullName().isEmpty() || student.getFullName().length() == 0) {
				throw new EmptyInputException(601, "please sent proper name,It blank", LocalDate.now());
			}
	...
	public List<Student> getAllStudent() {
			...
			if (listofstu.isEmpty()) {
				throw new CustomException(500, "Hey list is completely empty,we have nothing to return",
						LocalDate.now());
			}
			return listofstu;
//		} catch (Exception e) {
...
//		}
	...
	public String deleteStudent(Integer id) {
			...
			if (data.isPresent()) {
				...
				throw new CustomException(609, "given Student  id :- "+id+"is not found,please send some id to be searched",
						LocalDate.now());
			}
